...
\begin{multicols}{2}
  ...
  \subsubsection*{\textcolor{BrickRed}{\textbf{\bsc{Dexterity} : technical skill}}} 
  
  La \dexterity\ est une mesure de la profondeur de la connaissance d'une technologie.
  
  \subsubsection*{\textcolor{DarkOrchid}{\textbf{\bsc{Strength} : get stuff done}}} 
  
  La \strength\ est une mesure de la capacité à résoudre des problèmes.
  
  \subsubsection*{\textcolor{MidnightBlue}{\textbf{\bsc{Wisdom} : impact}}} 
  
  La \wisdom\ est une mesure de la capacité à prendre des décisions et à avoir de l'impact.
  
  \subsubsection*{\textcolor{OliveGreen}{\textbf{\bsc{Charisma} : communication \& leadership}}} 
