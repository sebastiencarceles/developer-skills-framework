...
\newcommand\dexterity{\textcolor{BrickRed}{\uppercase{ski} - \bsc{Technical Skills}}}
\newcommand\strength{\textcolor{DarkOrchid}{\uppercase{gsd} - \bsc{Get Stuff Done}}}
\newcommand\wisdom{\textcolor{MidnightBlue}{\uppercase{imp} - \bsc{Impact}}}
\newcommand\charisma{\textcolor{OliveGreen}{\uppercase{lea} - \bsc{Leadership and Communication}}}
...
\begin{multicols}{2}
  ...
  C'est la mesure de la connaissance d'une technologie, technique ou procédé.
  
  \subsubsection*{\strength} 
  
  C'est la mesure de la capacité à résoudre des problèmes.
  
  \subsubsection*{\wisdom} 
  
  C'est la mesure de la capacité à prendre des décisions et à avoir de l'impact.
  
  \subsubsection*{\charisma} 
  
  C'est la mesure de l'influence et de la capacité à inspirer les autres.
